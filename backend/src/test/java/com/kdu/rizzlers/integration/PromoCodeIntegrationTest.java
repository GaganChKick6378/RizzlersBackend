...
import com.kdu.rizzlers.controller.PromoCodeController;
...
public class PromoCodeIntegrationTest {
    ...
    public void getVisiblePromotions_shouldReturnAllVisiblePromotions() throws Exception {
        // Arrange
    ...
    @Test
    @DisplayName("Should validate promo code with GET request")
    public void validatePromoCodeByPath_shouldReturnPromotionDetails() throws Exception {
        // Arrange
    ...
    @Test
    @DisplayName("Should validate promo code with POST request")
    public void validatePromoCodePost_shouldReturnSimplifiedPromotionDetails() throws Exception {
        // Arrange
        PromoCodeValidateRequest request = PromoCodeValidateRequest.builder()
                .promoCode("SUMMER20")
                .build();
    ...
    public void validatePromoCode_withInvalidCode_shouldReturnError() throws Exception {
        // Arrange
        PromoCodeValidateRequest request = PromoCodeValidateRequest.builder()
                .promoCode("INVALID")
                .build();
